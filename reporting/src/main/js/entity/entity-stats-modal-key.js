...
/**
 * Foreign keys component for entity stats modal window
 *
...
export default class EntityStatsModalKey extends React.Component {
    ...
    render() {
        ...
        if (this.state.expanded) {
            ...
            items = keys.map((fk, i) => <span key={i} className="padded-list-item">{fk.localColumnName}
                -> {fk.foreignColumnName}</span>);
        }
        return (
